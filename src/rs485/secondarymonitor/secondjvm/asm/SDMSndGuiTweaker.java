...
public class SDMSndGuiTweaker extends FMLTweaker {
	
	public SDMSndGuiTweaker() throws ClassNotFoundException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public void injectIntoClassLoader(LaunchClassLoader classLoader) {
		classLoader.registerTransformer(SDMSndGuiClassTransformer.class.getName());
