package rs485.secondarymonitor.network;
...
public class PacketHandler implements IPacketHandler {
	...
	public static final void intialize() {
		if(init) return;
		init = true;
		final List<ClassInfo> classes = new ArrayList<ClassInfo>(ClassPath.from(PacketHandler.class.getClassLoader()).getTopLevelClassesRecursive("rs485.secondarymonitor.network.packets"));
